...
class SpecAugment():
    ...
    def __init__(self, mel_spectrogram, policy, zero_mean_normalized=True):
        ...
        if self.policy == 'LB':
            ...
            # proposed paparamters by the paper
            # self.W, self.F, self.m_F, self.T, self.p, self.m_T = 0, 16, 2, 64, 0.2, 2
            self.W, self.F, self.m_F, self.T, self.p, self.m_T = 0, 0, 2, 64, 0.2, 2
